"""
This platform allows several climate TRV devices to be grouped into one climate device.

For more details about this platform, please refer to the documentation at
https://github.com/jeremiedmns/climate_trv_group/
...
class ClimateGroup(ClimateEntity):
    ...
    def __init__(
        self, name: str, entity_ids: List[str], excluded: List[str], sensor: str
    ) -> None:
        """Initialize a climate group."""
        self._name = name  # type: str
        self._entity_ids = entity_ids  # type: List[str]
        self._sensor_entity_id = sensor
